...
# Zendesk Mobile SDK for iOS 1.6.1.1
...
We are aware that there are issues with the SDK when testing on iOS 10. We are currently working on a release of the SDK that addresses these issues, in line with our policy of supporting the current and previous two versions of iOS.
