 ...
 */
@property (nonatomic, strong) ZDKRequestComment *comment;
 ...
 */
- (void) prepareWithComment:(ZDKRequestComment*)comment;
 ...
 */
+ (CGFloat) cellHeightForComment:(ZDKRequestComment*)comment inWidth:(CGFloat)width;
