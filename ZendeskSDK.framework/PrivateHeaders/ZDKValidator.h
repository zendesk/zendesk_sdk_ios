...
/**
 *  @brief Convience macro for using @p zdk_NilSafeNSDictionaryOfVariableBindings.
 *
...
*  parameter names. There is a convience macro which creates a dictionary in the expected
*  format.
*  
